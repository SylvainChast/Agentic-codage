---
name: swarm-design-system
description: Define reusable UI components, visual tokens and accessible behaviors.
---

Run the Agentic Codage design-system procedure for the user's request.
Read `.framework/OPERATING.md` and identify the task from the request or current context.
Read only `.framework/method/design-system.md`, then use `framework method prompt design-system --task TASK`
