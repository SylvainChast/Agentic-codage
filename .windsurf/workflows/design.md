---
description: Design the local technical and UX solution for a feature.
---

# design

Run the Agentic Codage design procedure for the user's request.
Read `.framework/OPERATING.md` and identify the task from the request or current context.
Read only `.framework/method/design.md`, then use `framework method prompt design --task TASK`
