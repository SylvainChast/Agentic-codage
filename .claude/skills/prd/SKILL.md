---
name: prd
description: Create or revise requirements, success criteria and exclusions for a product.
---

Run the Agentic Codage prd procedure for the user's request.
Read `.framework/OPERATING.md` and identify the task from the request or current context.
Read only `.framework/method/prd.md`, then use `framework method prompt prd --task TASK`
