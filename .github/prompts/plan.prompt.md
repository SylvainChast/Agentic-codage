---
description: Produce a bounded implementation plan with dependencies and verification.
agent: agent
---

Run the Agentic Codage plan procedure for the user's request.
Read `.framework/OPERATING.md` and identify the task from the request or current context.
Read only `.framework/method/plan.md`, then use `framework method prompt plan --task TASK`
